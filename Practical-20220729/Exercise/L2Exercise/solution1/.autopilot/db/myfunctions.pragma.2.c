...
void m_add(int A[4][4], int B[4][4], int result[4][4]) {_ssdm_SpecArrayDimSize(A, 4);_ssdm_SpecArrayDimSize(B, 4);_ssdm_SpecArrayDimSize(result, 4);
...
# 35 "myfunctions.c"
int m_compare(int A[4][4], int B[4][4]) {_ssdm_SpecArrayDimSize(A, 4);_ssdm_SpecArrayDimSize(B, 4);
