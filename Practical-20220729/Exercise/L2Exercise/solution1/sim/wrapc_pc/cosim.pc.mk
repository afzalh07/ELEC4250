...
$(ObjDir)/matrix_math.c_pre.c.tb.o : matrix_math.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) matrix_math.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/myfunctions.c_pre.c.tb.o : myfunctions.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) myfunctions.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
