...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "m_add.autotvin.dat"
	set constFileTvOut       "m_add.autotvout.dat"
	set constFileHdlTvIn     "m_add.autohdltvin.dat"
	set constFileHdlTvOut    "m_add.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
