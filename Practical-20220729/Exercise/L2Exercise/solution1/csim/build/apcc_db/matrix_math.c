...
void m_add(signed int (*)[4], signed int (*)[4], signed int (*)[4]);
...
static signed int aesl_internal_main_OC_Ex_Add[4][4] = { { 2u, 4u, 6u, 10u }, { 2u, 10u, 60u, 8u }, { 2u, 4u, 6u, 10u }, { 2u, 10u, 6u, 8u } };
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @m_add([4 x i32]* %%5, [4 x i32]* %%6, [4 x i32]* %%7) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_11_count);
  m_add(llvm_cbe_tmp__5, llvm_cbe_tmp__6, llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
