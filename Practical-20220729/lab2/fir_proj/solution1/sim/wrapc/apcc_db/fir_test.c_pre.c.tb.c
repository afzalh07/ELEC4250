...
void AESL_WRAP_fir(signed int *, signed int *, signed int );
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = bitcast [11 x i32]* %%taps to i8*, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_4_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = call %%struct._iobuf* @fopen(i8* getelementptr inbounds ([8 x i8]* @aesl_internal_.str, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @aesl_internal_.str1, i64 0, i64 0)) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_17_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = getelementptr inbounds [11 x i32]* %%taps, i64 0, i64 0, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_25_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = load i32* %%output, align 4, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_48_count);
  llvm_cbe_tmp__9 = (unsigned int )*(&llvm_cbe_output);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%3, i8* getelementptr inbounds ([10 x i8]* @aesl_internal_.str2, i64 0, i64 0), i32 %%storemerge10, i32 %%storemerge24, i32 %%17) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_49_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = add nsw i32 %%storemerge10, 1, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_50_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_fir(i32* %%output, i32* %%4, i32 %%9) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_32_count);
  AESL_WRAP_fir((signed int *)(&llvm_cbe_output), (signed int *)llvm_cbe_tmp__4, llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__6);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%. = select i1 %%10, i32 0, i32 1, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe__2e__count);
...
llvm_cbe_tmp__34:
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = add nsw i32 %%storemerge239, -1, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_35_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_fir(i32* %%output, i32* %%4, i32 %%12) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_36_count);
  AESL_WRAP_fir((signed int *)(&llvm_cbe_output), (signed int *)llvm_cbe_tmp__4, llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE) {
...
llvm_cbe_tmp__36:
if (AESL_DEBUG_TRACE)
printf("\n  %%.8 = zext i1 %%15 to i32, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe__2e_8_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = call i32 bitcast (i32 (...)* @system to i32 (i8*)*)(i8* getelementptr inbounds ([29 x i8]* @aesl_internal_.str4, i64 0, i64 0)) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_57_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = call i64 @fwrite(i8* getelementptr inbounds ([45 x i8]* @aesl_internal_.str5, i64 0, i64 0), i64 44, i64 1, %%struct._iobuf* %%26), !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_62_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = call %%struct._iobuf* @__iob_func() nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_63_count);
  llvm_cbe_tmp__17 = (l_struct_OC__iobuf *)__iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__17);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = getelementptr inbounds %%struct._iobuf* %%28, i64 1, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_64_count);
  llvm_cbe_tmp__18 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__17[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = call i64 @fwrite(i8* getelementptr inbounds ([47 x i8]* @aesl_internal_.str6, i64 0, i64 0), i64 46, i64 1, %%struct._iobuf* %%29), !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_65_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%38 = call %%struct._iobuf* @__iob_func() nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_73_count);
  llvm_cbe_tmp__26 = (l_struct_OC__iobuf *)__iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__26);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = getelementptr inbounds %%struct._iobuf* %%38, i64 1, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_74_count);
  llvm_cbe_tmp__27 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__26[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = call i64 @fwrite(i8* getelementptr inbounds ([45 x i8]* @aesl_internal_.str7, i64 0, i64 0), i64 44, i64 1, %%struct._iobuf* %%39), !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_75_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%43 = call i64 @fwrite(i8* getelementptr inbounds ([45 x i8]* @aesl_internal_.str5, i64 0, i64 0), i64 44, i64 1, %%struct._iobuf* %%42), !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_78_count);
  fwrite(( char *)((&aesl_internal__OC_str5[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 45
#endif
